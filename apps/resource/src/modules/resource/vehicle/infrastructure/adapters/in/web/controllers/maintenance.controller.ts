...
export class MaintenanceController {
    ...
    //   return this.toResponseDto(maintenance);
    // }
    ...
    //   return maintenances.map(maintenance => this.toResponseDto(maintenance));
    // }
    ...
    //   await this.maintenanceService.remove(maintenanceId);
    // }
}
